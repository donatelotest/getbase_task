...
class GetBaseTask(unittest.TestCase):
    ...
    def test_interviewTask(self):
        ...
        for i in range(60):
            try:
                if "Dashboard" == driver.find_element_by_css_selector("h1").text: break
            except: pass
            time.sleep(1)
    ...
    def storeSettings(self):
        ...
        #self.printCustomFields(customFieldsLeadsList, 'Leads')
        ...
        #self.printCustomFields(customFieldsContactsList, 'Contacts')
        ...
        #self.printCustomFields(customFieldsDealsList, 'Deals')
